        ...
        <div class="flex-w flex-tr">
            ...
            -->
                    <div class="alert alert-danger" ng-show="contactForm.$invalid">
                        <ul>
                            <!-- Thông báo lỗi email -->
                            <li><span class="error" ng-show="contactForm.sdt.$error.required">Vui lòng nhập số điện thoại</span></li>
                            ...
                            <li><span class="error" ng-show="contactForm.message.$error.maxlength">Lời nhắn phải <= 250 ký tự</span> </li> </li> </div> <!-- Div Thông báo validate hợp lệ Chỉ hiển thị khi các validate trong form `contactForm` không hợp lệ=> contactForm.$valid = true
                                        ...
                                        <div class="bor8 m-b-20 how-pos4-parent">
                                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="sdt" placeholder="Số điện thoại của bạn" ng-model="sdt" ng-required=true>
                                            <span class="valid" ng-show="userInfo.sdt.$valid">Hợp lệ</span>
                                        </div>
                                        <!-- Validate email -->
                                        <div class="bor8 m-b-20 how-pos4-parent">
        ...
        $scope.submitContactForm = function() {
            ...
            if ($scope.contactForm.$valid) {
                ...
                var dataInputContactForm = {
                    "sdt": $scope.contactForm.sdt.$viewValue,
