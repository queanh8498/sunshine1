<!-- Hien thi gio hang, Xac nhan gio hang ; localhost:8000\gio-hang -->
                ...
                <div class="alert alert-danger" ng-show="orderForm.$invalid">
                    <ul>
                        ...
                        <li><span class="error" ng-show="orderForm.kh_dienThoai.$error.maxlength">Điện thoại phải <= 11 ký tự</span> </li> </li> </div> <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kh_taiKhoan" name="kh_taiKhoan" ng-model="kh_taiKhoan"  ng-maxlength="50" ng-required=true>
                </div>
